...
//	    @FindBy(xpath="//a[contains(@href,'list-contact')]")WebElement pageutility_ManageContactPageMoreInfo;
	...
	WebElement pageutility_ContactPageEdit;
	@FindBy(xpath = "//input[@name='phone']")
	WebElement pageutilty_ContactPagePhone;
	@FindBy(xpath = "//input[@name='email']")
	WebElement pageutilty_ContactPageEmail;
	@FindBy(xpath = "//textarea[@name='address']")
	WebElement pageutilty_ContactPageAddress;
	@FindBy(xpath = "//textarea[@name='del_time']")
	WebElement pageutilty_ContactPageCT;
	@FindBy(xpath = "//input[@name='del_limit']")
	WebElement pageutilty_ContactPageDCT;
	@FindBy(xpath = "//button[@type='submit']")
	WebElement pageutilty_ContactPageUpdate;
...
//	}
	...
	public ContactPage contactPageEditButtonClick() {
		pageutility.click_On_Element(pageutility_ContactPageEdit);
		return this;
	}

	public ContactPage contactPageEnterPhone(String phone) {
	...
	public ContactPage contactPageEnterEmail(String email) {
		// username.sendKeys(user);
	...
	public ContactPage contactPageEnterAddress(String address) {
		// username.sendKeys(user);
	...
	public ContactPage contactPageEnterCT(String CT) {
		// username.sendKeys(user);
	...
	public ContactPage contactPageEnterDCT(String DCT) {
		// username.sendKeys(user);
	...
	public ContactPage ContactPageUpdateButtonClick() {
