...
public class AdminPage {
	...
	// and @class='small-box-footer']")WebElement pageutility_ManageAdminMoreInfo;
	// @FindBy(xpath="//a[@class='btn btn-rounded btn-danger']")WebElement
	// pageutility_adminnewbutton;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement pageutility_adminnewbutton;
	@FindBy(xpath = "//input[@id='username']")
	WebElement pageutilty_admininputusername;
	@FindBy(xpath = "//input[@id='password']")
	WebElement pageutilty_admininputpassword;
	@FindBy(xpath = "//select[@id='user_type']")
	WebElement pageutilty_admindropdownlist;
	@FindBy(xpath = "//button[@name='Create']")
	WebElement pageutility_admincreate;
...
//}
	public AdminPage adminNewButtonclick() {
...
//password.sendKeys(passwd);
	...
	public AdminPage adminTypeDropdownlistSelection(String admindropdownlist) {
		pageutility.selectByVisibleTextDropdownMethod(pageutilty_admindropdownlist, admindropdownlist);
		return this;
		// pageutility.send_data_to_element(pageutility_newsaddtestarea,
		// "ABrainingsrtest");
	}

	public AdminPage adminCreateButtonClick() {
